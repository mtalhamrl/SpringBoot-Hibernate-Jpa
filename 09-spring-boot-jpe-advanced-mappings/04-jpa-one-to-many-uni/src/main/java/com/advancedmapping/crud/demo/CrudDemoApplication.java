...
import com.advancedmapping.crud.demo.entity.Review;
...
public class CrudDemoApplication {
	...
	private void createCourseAndReviews(AppDAO appDAO) {
		//create course
		Course tempCourse = new Course("Coding");
		//create reviews
		tempCourse.addReview(new Review("great coursee"));
		tempCourse.addReview(new Review("good job"));
		tempCourse.addReview(new Review("too expensive"));
		//save course
